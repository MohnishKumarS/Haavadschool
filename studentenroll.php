...
<html lang="en">
  <head>
	...
	<title>Student Enrollement  Haavad International School</title>
	...
	<meta name='url' content='http://harvardcbse.com/studentenrollement'>
  ...
  <body>
	<?php include 'control-panel/php/header.php'?>
		       ...
		       <div class="About-page-text text-center">
			        <h1><i class="fa fa-group" aria-hidden="true"></i>&nbsp;Student Enrollement</h1>
		          </div>
	          </div>  
			      <div class="about-mv">
		         <div class="container">
	           ...
	           <p><b>At present, we are conducting classes up to Std VII. <br>
                     Strength Details coming soon... </b>
               </p>
