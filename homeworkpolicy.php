...
<html lang="en">
  <head>
	...
	<meta name='url' content='http://harvardcbse.com/aboutus'>
  ...
  <body>
	<?php include 'control-panel/php/header.php'?>
	           ...
	           <div id="About-page-fold">
		       <div class="About-page-text text-center">
			        <h1><i class="fa fa-group" aria-hidden="true"></i>&nbsp;Homework Policy</h1>
		          </div>
	          </div> 
		         ...
		         <div class="container">
			       ...
			       <br><br>
					<p><strong>No homework policy for classes I and II: </strong></p></br>

							   

                        <p> According to the new School Bag Policy 2020 released by the Ministry of Education, children up to class 2
should not be given any homework as they are too young to sit for long hours and they should carry a bag
weighing not more than 2 kg.</p></br>
